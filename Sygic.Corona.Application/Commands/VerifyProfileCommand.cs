...
namespace Sygic.Corona.Application.Commands
{
    public class VerifyProfileCommand : IRequest
    {
        ...
        public string SignedAttestationStatement { get; set; }

        public VerifyProfileCommand(string deviceId, long profileId, string covidPass, string nonce, string signedAttestationStatement)
        {
